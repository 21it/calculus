...
Not a lot. We have 2 functions `is?` and `return` which are probably generated by `defcalculus` macro. Let's check documentation generated for those functions:
